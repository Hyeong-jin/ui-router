...
-
**참고:** *UI-Router는 한창 개발 중이다. 이 라이브러리는 잘 테스트하고 있는 중이라서, API가 바뀔 수 있다. 양산 애플리케이션에서의 사용은 변경로그를 팔로잉하여 그에 따라 당신이 사용하는 것을 업데이트하는 것에 익숙한가 숙고하여 사용하라.*
...
**(3)** [`ui-sref` 디렉티브](https://github.com/angular-ui/ui-router/wiki/Quick-Reference#ui-sref)를 가진 몇 개의 링크를 추가한 것에 알 수 있을 것이다. 
